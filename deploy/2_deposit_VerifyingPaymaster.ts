...
async function main (): Promise<void> {
  ...
  console.log('Deposit to VerifingPaymaster...')
  const tx = await VerifyingPaymaster__factory.connect(addr, owner).deposit({ value: ethers.utils.parseEther(DepositeAmount) })
  await tx.wait()
